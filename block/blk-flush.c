...
enum
{
    ...
    REQ_FSEQ_ACTIONS = REQ_FSEQ_PREFLUSH | REQ_FSEQ_DATA | REQ_FSEQ_POSTFLUSH,
                           ...
                           blk_opf_t flags)
{
    ...
    /* C2 and C3 */
    if (fq->flush_data_in_flight && time_before(jiffies, fq->flush_pending_since + FLUSH_PENDING_TIMEOUT))
        return;
