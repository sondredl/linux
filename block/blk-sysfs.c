                              ...
                              size_t count)
{
    ...
    else if (!strncmp(page, "write through", 13) || !strncmp(page, "none", 4))
    {
                                  ...
                                  int n)
{
    ...
    if ((attr == &queue_max_open_zones_entry.attr || attr == &queue_max_active_zones_entry.attr) && !blk_queue_is_zoned(q))
        return 0;
