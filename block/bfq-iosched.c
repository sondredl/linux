...
#define BFQ_RQ_SEEKY(bfqd, last_pos, rq) \
    (get_sdist(last_pos, rq) > BFQQ_SEEK_THR && (!blk_queue_nonrot(bfqd->queue) || blk_rq_sectors(rq) < BFQQ_SECT_THR_NONROT))
...
retry:
    ...
    for (level--; level >= 0; level--)
    {
        ...
        else
        {
            ...
            {
                wsum = wsum * IOPRIO_BE_NR + sched_data->service_tree[i].wsum;
            }
        }
        if (!wsum)
            continue;
                                    ...
                                    struct bfq_queue *bfqq)
{
    ...
    bool multiple_classes_busy =
        (bfqd->busy_queues[0] && bfqd->busy_queues[1]) || (bfqd->busy_queues[0] && bfqd->busy_queues[2]) || (bfqd->busy_queues[1] && bfqd->busy_queues[2]);
...
{
    return bfqq->ref - bfqq->entity.allocated - bfqq->entity.on_st_or_in_serv - (bfqq->weight_counter != NULL) - bfqq->stable_ref;
}
...
static unsigned int bfq_actuator_index(struct bfq_data *bfqd, struct bio *bio)
{
    ...
    {
        if (end >= bfqd->sector[i] && end < bfqd->sector[i] + bfqd->nr_sectors[i])
            return i;
    }
                                             ...
                                             bool             *interactive)
{
    bool soft_rt, in_burst, wr_or_deserves_wr,
         ...
         */
        arrived_in_time  = blk_time_get_ns() <= bfqq->ttime.last_end_request + bfqd->bfq_slice_idle * 3;
    ...
    soft_rt      = bfqd->bfq_wr_max_softrt_rate > 0 && !BFQQ_TOTALLY_SEEKY(bfqq) && !in_burst && time_is_before_jiffies(bfqq->soft_rt_next_start) && bfqq->dispatched == 0 && bfqq->entity.new_weight == 40;
    *interactive = !in_burst && idle_for_long_time && bfqq->entity.new_weight == 40;
     ...
     * raising.
     */
    wr_or_deserves_wr = bfqd->low_latency && (bfqq->wr_coeff > 1 || (bfq_bfqq_sync(bfqq) && bfqq_non_merged_or_stably_merged && (*interactive || soft_rt)));
     ...
     */
    if (bfqd->in_service_queue && ((bfqq_wants_to_preempt && bfqq->wr_coeff >= bfqd->in_service_queue->wr_coeff) || bfq_bfqq_higher_class_or_weight(bfqq, bfqd->in_service_queue) || !bfq_better_to_idle(bfqd->in_service_queue)) && next_queue_may_preempt(bfqd))
                            ...
                            u64 now_ns)
{
    ...
    if (!bfqd->last_completed_rq_bfqq || bfqd->last_completed_rq_bfqq == bfqq || bfq_bfqq_has_short_ttime(bfqq) || now_ns - bfqd->last_completion >= 4 * NSEC_PER_MSEC || bfqd->last_completed_rq_bfqq == &bfqd->oom_bfqq || bfqq == &bfqd->oom_bfqq)
        return;
     ...
     */
    if (bfqd->last_completed_rq_bfqq != bfqq->tentative_waker_bfqq || now_ns > bfqq->waker_detection_started + 128 * (u64)bfqd->bfq_slice_idle)
    {
        /*
...
static void bfq_add_request(struct request *rq)
{
    ...
    if (bfq_bfqq_sync(bfqq) && RQ_BIC(rq)->requests <= 1)
    {
         ...
         *   elapsed.
         */
        if (bfqq == bfqd->in_service_queue && (bfqd->tot_rq_in_driver == 0 || (bfqq->last_serv_time_ns > 0 && bfqd->rqs_injected && bfqd->tot_rq_in_driver > 0)) && time_is_before_eq_jiffies(bfqq->decrease_time_jif + msecs_to_jiffies(10)))
        {
                         ...
                         void *io_struct, bool request, struct bfq_io_cq *bic)
{
    ...
    if (unlikely(!bfqd->nonrot_with_queueing))
    {
         ...
         */
        if (bfq_bfqq_sync(bfqq) && bfqq_data->stable_merge_bfqq && !bfq_bfqq_just_created(bfqq) && time_is_before_jiffies(bfqq->split_time + msecs_to_jiffies(bfq_late_stable_merging)) && time_is_before_jiffies(bfqq->creation_time + msecs_to_jiffies(bfq_late_stable_merging)))
        {
            struct bfq_queue *stable_merge_bfqq =
...
{
    if (cur_bfqq->entity.parent && cur_bfqq->entity.parent->last_bfqq_created == cur_bfqq)
                    ...
                    struct bfq_queue *bfqq, struct bfq_queue *new_bfqq)
{
     ...
     * I/O.
     */
    if (bfqq->waker_bfqq && !new_bfqq->waker_bfqq && bfqq->waker_bfqq != new_bfqq)
    {
...
static void bfq_update_peak_rate(struct bfq_data *bfqd, struct request *rq)
{
     ...
     */
    if (now_ns - bfqd->last_dispatch > 100 * NSEC_PER_MSEC && bfqd->tot_rq_in_driver == 0)
        goto update_rate_and_reset;

    /* Update sampling information */
    bfqd->peak_rate_samples++;

    if ((bfqd->tot_rq_in_driver > 0 || now_ns - bfqd->last_completion < BFQ_MIN_TT)
                                                 ...
                                                 struct bfq_queue *bfqq)
{
    ...
    return (bfqq->wr_coeff > 1 && (bfqd->wr_busy_queues < tot_busy_queues || bfqd->tot_rq_in_driver >= bfqq->dispatched + 4)) || bfq_asymmetric_scenario(bfqd, bfqq) || tot_busy_queues == 1;
}
    ...
    bfq_choose_bfqq_for_injection(struct bfq_data *bfqd)
{
    ...
    for (i = 0; i < bfqd->num_actuators; i++)
    {
        list_for_each_entry(bfqq, &bfqd->active_list[i], bfqq_list) if (!RB_EMPTY_ROOT(&bfqq->sort_list) && (in_serv_always_inject || bfqq->wr_coeff > 1) && bfq_serv_to_charge(bfqq->next_rq, bfqq) <= bfq_bfqq_budget_left(bfqq))
        {
            /*
             ...
             * at a time.
             */
            if (blk_queue_nonrot(bfqd->queue) && blk_rq_sectors(bfqq->next_rq) >= BFQQ_SECT_THR_NONROT && bfqd->tot_rq_in_driver >= 1)
                continue;
            else
            {
    ...
    bfq_find_active_bfqq_for_actuator(struct bfq_data *bfqd, int idx)
{
    ...
    {
        if (!RB_EMPTY_ROOT(&bfqq->sort_list) && bfq_serv_to_charge(bfqq->next_rq, bfqq) <= bfq_bfqq_budget_left(bfqq))
        {
            return bfqq;
        }
    }
    ...
    bfq_find_bfqq_for_underused_actuator(struct bfq_data *bfqd)
{
    ...
    for (i = 0; i < bfqd->num_actuators; i++)
    {
        if (bfqd->rq_in_driver[i] < bfqd->actuator_load_threshold && (i == bfqd->num_actuators - 1 || bfqd->rq_in_driver[i] < bfqd->rq_in_driver[i + 1]))
        {
            struct bfq_queue *bfqq =
...
check_queue:
    ...
    if (bfq_bfqq_wait_request(bfqq) || (bfqq->dispatched != 0 && bfq_better_to_idle(bfqq)))
    {
        ...
        struct bfq_queue *blocked_bfqq =
            !hlist_empty(&bfqq->woken_list) ? container_of(bfqq->woken_list.first,
                                                           struct bfq_queue,
                                                           woken_list_node)
                                            : NULL;

        if (bfqq->bic && bfqq->bic->bfqq[0][act_idx] && bfq_bfqq_busy(bfqq->bic->bfqq[0][act_idx]) && bfqq->bic->bfqq[0][act_idx]->next_rq)
        ...
        if (async_bfqq && icq_to_bic(async_bfqq->next_rq->elv.icq) == bfqq->bic && bfq_serv_to_charge(async_bfqq->next_rq, async_bfqq) <= bfq_bfqq_budget_left(async_bfqq))
            bfqq = async_bfqq;
        else if (bfqq->waker_bfqq && bfq_bfqq_busy(bfqq->waker_bfqq) && bfqq->waker_bfqq->next_rq && bfq_serv_to_charge(bfqq->waker_bfqq->next_rq, bfqq->waker_bfqq) <= bfq_bfqq_budget_left(bfqq->waker_bfqq))
            bfqq = bfqq->waker_bfqq;
        else if (blocked_bfqq && bfq_bfqq_busy(blocked_bfqq) && blocked_bfqq->next_rq && bfq_serv_to_charge(blocked_bfqq->next_rq, blocked_bfqq) <= bfq_bfqq_budget_left(blocked_bfqq))
            bfqq = blocked_bfqq;
...
static bool bfq_has_work(struct blk_mq_hw_ctx *hctx)
{
     ...
     */
    return !list_empty_careful(&bfqd->dispatch) || READ_ONCE(bfqd->queued);
}
...
static struct bfq_queue *bfq_do_or_sched_stable_merge(struct bfq_data  *bfqd,
                                                      ...
                                                      struct bfq_io_cq *bic)
{
    struct bfq_queue **source_bfqq = bfqq->entity.parent ? &bfqq->entity.parent->last_bfqq_created : &bfqd->last_bfqq_created;
     ...
     */
    if (!last_bfqq_created || time_before(last_bfqq_created->creation_time + msecs_to_jiffies(bfq_activation_stable_merging), bfqq->creation_time) || bfqq->entity.parent != last_bfqq_created->entity.parent || bfqq->ioprio != last_bfqq_created->ioprio || bfqq->ioprio_class != last_bfqq_created->ioprio_class || bfqq->actuator_idx != last_bfqq_created->actuator_idx)
        *source_bfqq = bfqq;
    else if (time_after_eq(last_bfqq_created->creation_time + bfqd->bfq_burst_interval,
                           bfqq->creation_time))
    {
        if (likely(bfqd->nonrot_with_queueing))
            /*
                           ...
                           struct request *rq)
{
    ...
    {
        if (time_is_before_jiffies(bfqq->wr_start_at_switch_to_srt + bfq_wr_duration(bfqd)))
        {
            /*
                                       ...
                                       struct bfq_io_cq *bic)
{
     ...
     */
    if (atomic_read(&bic->icq.ioc->active_ref) == 0 || (bfq_sample_valid(bfqq->ttime.ttime_samples) && bfqq->ttime.ttime_mean > bfqd->bfq_slice_idle >> 1))
...
static void bfq_update_hw_tag(struct bfq_data *bfqd)
{
     ...
     * case
     */
    if (bfqq && bfq_bfqq_has_short_ttime(bfqq) && bfqq->dispatched + bfqq->queued[0] + bfqq->queued[1] < BFQ_HW_QUEUE_THRESHOLD && bfqd->tot_rq_in_driver < BFQ_HW_QUEUE_THRESHOLD)
        return;
                                    ...
                                    struct bfq_queue *bfqq)
{
     ...
     */
    if ((bfqq->last_serv_time_ns == 0 && bfqd->tot_rq_in_driver == 1) || tot_time_ns < bfqq->last_serv_time_ns)
    {
                                                   ...
                                                   bool *new_queue)
{
    ...
    if (split && is_sync)
    {
        if ((bfqq_data->was_in_burst_list && bfqd->large_burst) || bfqq_data->saved_in_large_burst)
            bfq_mark_bfqq_in_large_burst(bfqq);
        else
        {
            bfq_clear_bfqq_in_large_burst(bfqq);
...
static struct bfq_queue *bfq_init_rq(struct request *rq)
{
    ...
    if (likely(!new_queue))
    {
        ...
        if (bfq_bfqq_coop(bfqq) && bfq_bfqq_split_coop(bfqq) && !bic->bfqq_data[a_idx].stably_merged)
        {
            struct bfq_queue *old_bfqq = bfqq;
