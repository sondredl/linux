 ...
 * 32-bit hosts.
 */
#if defined(CONFIG_CC_IS_CLANG) && __clang_major__ <= 13 && BITS_PER_LONG != 64
...
#define DEFINE_TEST_FUNC_TYPED(n, t, fmt)                                                                                               \
    ...
    {                                                                                                                                   \
        ...
        SKIP_SIGN_MISMATCH(__same_type(n##_tests[0].a, u32) && __same_type(n##_tests[0].b, u32) && __same_type(n##_tests[0].sum, int)); \
                                                                                                                                        \
...
#define __TEST_OVERFLOWS_TYPE(func, arg1, arg2, of)                                    \
    do                                                                                 \
    {                                                                                  \
...
#define TEST_OVERFLOWS_TYPE(__t1, __t2, v, of)                           \
    do                                                                   \
    {                                                                    \
        __t1 t1 = (v);                                                   \
        __t2 t2;                                                         \
...
#define TEST_SAME_TYPE(t1, t2, same)                         \
    do                                                       \
    {                                                        \
...
#else
    #define TEST_SAME_TYPE64(base, t, m) \
        do                               \
        {                                \
        } while (0)
#endif
...
#define TEST_CASTABLE_TO_TYPE(arg1, arg2, pass)                                            \
    do                                                                                     \
    {                                                                                      \
...
#define TEST_CASTABLE_TO_TYPE_VAR(width)                                 \
    do                                                                   \
    {                                                                    \
...
#define TEST_CASTABLE_TO_TYPE_RANGE(width)                                              \
    do                                                                                  \
    {                                                                                   \
