...
static __always_inline
    size_t
    copy_to_user_iter(void __user *iter_to, size_t progress,
...
static __always_inline
    size_t
    copy_to_user_iter_nofault(void __user *iter_to, size_t progress,
                              size_t len, void *from, void *priv2)
{
    ssize_t res;
...
static __always_inline
    size_t
    copy_from_user_iter(void __user *iter_from, size_t progress,
...
static __always_inline
    size_t
    memcpy_to_iter(void *iter_to, size_t progress,
                   size_t len, void *from, void *priv2)
{
...
static __always_inline
    size_t
    memcpy_from_iter(void *iter_from, size_t progress,
                     size_t len, void *to, void *priv2)
{
...
static __always_inline
    size_t
    copy_to_user_iter_mc(void __user *iter_to, size_t progress,
                         size_t len, void *from, void *priv2)
{
    if (access_ok(iter_to, len))
    {
...
static __always_inline
    size_t
    memcpy_to_iter_mc(void *iter_to, size_t progress,
                      size_t len, void *from, void *priv2)
{
...
static __always_inline
    size_t
    __copy_from_iter(void *addr, size_t bytes, struct iov_iter *i)
{
...
static __always_inline
    size_t
    copy_from_user_iter_nocache(void __user *iter_from, size_t progress,
                                size_t len, void *to, void *priv2)
{
...
static __always_inline
    size_t
    copy_from_user_iter_flushcache(void __user *iter_from, size_t progress,
                                   size_t len, void *to, void *priv2)
{
...
static __always_inline
    size_t
    memcpy_from_iter_flushcache(void *iter_from, size_t progress,
                                size_t len, void *to, void *priv2)
{
...
static __always_inline
    size_t
    zero_to_user_iter(void __user *iter_to, size_t progress,
...
static __always_inline
    size_t
    zero_to_iter(void *iter_to, size_t progress,
                 size_t len, void *priv, void *priv2)
{
...
{
    if (WARN_ON_ONCE(!iov_iter_is_bvec(i) && !iter_is_iovec(i) && !iter_is_ubuf(i)) && !iov_iter_is_kvec(i))
        return;
