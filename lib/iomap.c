 ...
 */
__no_kmsan_checks unsigned int ioread8(const void __iomem *addr)
{
    IO_COND(addr, return inb(port), return readb(addr));
    return 0xff;
}
__no_kmsan_checks unsigned int ioread16(const void __iomem *addr)
{
    IO_COND(addr, return inw(port), return readw(addr));
    return 0xffff;
}
__no_kmsan_checks unsigned int ioread16be(const void __iomem *addr)
{
...
__no_kmsan_checks
    u64
    ioread64_lo_hi(const void __iomem *addr)
{
...
__no_kmsan_checks
    u64
    ioread64_hi_lo(const void __iomem *addr)
{
...
__no_kmsan_checks
    u64
    ioread64be_lo_hi(const void __iomem *addr)
{
...
__no_kmsan_checks
    u64
    ioread64be_hi_lo(const void __iomem *addr)
{
