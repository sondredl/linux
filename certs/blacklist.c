...
#define BLACKLIST_KEY_PERM (KEY_POS_SEARCH | KEY_POS_VIEW | KEY_USR_SEARCH | KEY_USR_VIEW)
...
{
    if (is_hash_blacklisted(hash, hash_len, BLACKLIST_HASH_BINARY) == -EKEYREJECTED)
        return -EPERM;
...
static int __init blacklist_init(void)
{
    ...
    blacklist_keyring =
        keyring_alloc(".blacklist",
                      ...
                      KEY_POS_VIEW | KEY_POS_READ | KEY_POS_SEARCH | KEY_POS_WRITE | KEY_USR_VIEW | KEY_USR_READ | KEY_USR_SEARCH
#ifdef CONFIG_SYSTEM_BLACKLIST_AUTH_UPDATE
                          | KEY_USR_WRITE
#endif
                      ,
