...
static int ipc_permissions(struct ctl_table_header *head, const struct ctl_table *table)
{
    ...
    if (((table->data == &ns->ids[IPC_SEM_IDS].next_id) || (table->data == &ns->ids[IPC_MSG_IDS].next_id) || (table->data == &ns->ids[IPC_SHM_IDS].next_id)) && checkpoint_restore_ns_capable(ns->user_ns))
        mode = 0666;
    else
#endif
    {
