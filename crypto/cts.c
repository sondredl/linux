...
static int cts_cbc_encrypt(struct skcipher_request *req)
{
    ...
    skcipher_request_set_callback(subreq, req->base.flags & CRYPTO_TFM_REQ_MAY_BACKLOG,
...
static int crypto_cts_init_tfm(struct crypto_skcipher *tfm)
{
    ...
    reqsize = ALIGN(sizeof(struct crypto_cts_reqctx) + crypto_skcipher_reqsize(cipher),
