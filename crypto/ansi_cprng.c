...
static struct rng_alg rng_algs[] = {{.generate = cprng_get_random,
                                     .seed     = cprng_reset,
                                    ...
                                    {.generate = fips_cprng_get_random, .seed = fips_cprng_reset, .seedsize = DEFAULT_PRNG_KSZ + 2 * DEFAULT_BLK_SZ, .base = {
