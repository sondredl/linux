                                 ...
                                 void *dst, unsigned int dlen)
{
    ...
    return crypto_akcipher_sync_prep(&data) ?: crypto_akcipher_sync_post(&data, crypto_akcipher_encrypt(data.req));
}
                                 ...
                                 void *dst, unsigned int dlen)
{
    ...
    return crypto_akcipher_sync_prep(&data) ?: crypto_akcipher_sync_post(&data, crypto_akcipher_decrypt(data.req)) ?
                                                                                                                   : data.dlen;
}
