...
#define f_rn(bo, bi, n, k)                                                                                                                                                                          \
    do                                                                                                                                                                                              \
    {                                                                                                                                                                                               \
        bo[n] = crypto_ft_tab[0][byte(bi[n], 0)] ^ crypto_ft_tab[1][byte(bi[(n + 1) & 3], 1)] ^ crypto_ft_tab[2][byte(bi[(n + 2) & 3], 2)] ^ crypto_ft_tab[3][byte(bi[(n + 3) & 3], 3)] ^ *(k + n); \
    } while (0)
...
#define f_rl(bo, bi, n, k)                                                                                                                                                                          \
    do                                                                                                                                                                                              \
    {                                                                                                                                                                                               \
        bo[n] = crypto_fl_tab[0][byte(bi[n], 0)] ^ crypto_fl_tab[1][byte(bi[(n + 1) & 3], 1)] ^ crypto_fl_tab[2][byte(bi[(n + 2) & 3], 2)] ^ crypto_fl_tab[3][byte(bi[(n + 3) & 3], 3)] ^ *(k + n); \
    } while (0)
...
#define i_rn(bo, bi, n, k)                                                                                                                                                                          \
    do                                                                                                                                                                                              \
    {                                                                                                                                                                                               \
        bo[n] = crypto_it_tab[0][byte(bi[n], 0)] ^ crypto_it_tab[1][byte(bi[(n + 3) & 3], 1)] ^ crypto_it_tab[2][byte(bi[(n + 2) & 3], 2)] ^ crypto_it_tab[3][byte(bi[(n + 1) & 3], 3)] ^ *(k + n); \
    } while (0)
...
#define i_rl(bo, bi, n, k)                                                                                                                                                                          \
    do                                                                                                                                                                                              \
    {                                                                                                                                                                                               \
        bo[n] = crypto_il_tab[0][byte(bi[n], 0)] ^ crypto_il_tab[1][byte(bi[(n + 3) & 3], 1)] ^ crypto_il_tab[2][byte(bi[(n + 2) & 3], 2)] ^ crypto_il_tab[3][byte(bi[(n + 1) & 3], 3)] ^ *(k + n); \
    } while (0)
