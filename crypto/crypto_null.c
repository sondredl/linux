...
static struct crypto_alg null_algs[] = {{.cra_name        = "cipher_null",
                                        ...
                                        {.cra_name = "compress_null", .cra_driver_name = "compress_null-generic", .cra_flags = CRYPTO_ALG_TYPE_COMPRESS, .cra_blocksize = NULL_BLOCK_SIZE, .cra_ctxsize = 0, .cra_module = THIS_MODULE, .cra_u = {.compress = {.coa_compress = null_compress, .coa_decompress = null_compress}}}};
