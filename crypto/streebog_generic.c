...
static const struct streebog_uint512 buffer512 = {{cpu_to_le64(0x200), 0, 0, 0, 0, 0, 0, 0}};
...
static struct shash_alg algs[2] = {{
                                   ...
                                   {.digestsize = STREEBOG512_DIGEST_SIZE, .init = streebog_init, .update = streebog_update, .final = streebog_final, .descsize = sizeof(struct streebog_state), .base = {
