...
static bool is_ignored_symbol(const char *name, char type)
{
    ...
    if (toupper(type) == 'A')
    {
        ...
        if (strcmp(name, "__kernel_syscall_via_break") && strcmp(name, "__kernel_syscall_via_epc") && strcmp(name, "__kernel_sigtramp") && strcmp(name, "__gp"))
            return true;
    }
...
static int symbol_valid(const struct sym_entry *s)
{
    ...
    if (!all_symbols)
    {
         ...
         */
        if (string_starts_with(name, "__start_") || string_starts_with(name, "__stop_"))
            return 1;
         ...
         * rules.
         */
        if ((s->addr == text_range_text->end && strcmp(name, text_range_text->end_sym)) || (s->addr == text_range_inittext->end && strcmp(name, text_range_inittext->end_sym)))
            return 0;
    }
