                                             ...
                                             struct dev_pagemap *pgmap)
{
    ...
    unsigned long offset   = start_pfn - PHYS_PFN(pgmap->ranges[pgmap->nr_range].start);
                                                 ...
                                                 struct dev_pagemap *pgmap)
{
    ...
    if (WARN_ON_ONCE(!IS_ALIGNED(pfn, PAGES_PER_SUBSECTION) || !IS_ALIGNED(nr_pages, PAGES_PER_SUBSECTION)))
        return NULL;
