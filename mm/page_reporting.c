                                ...
                                struct scatterlist *sgl, struct zone *zone)
{
    ...
    watermark = low_wmark_pages(zone) + (PAGE_REPORTING_CAPACITY << page_reporting_order);
...
void page_reporting_unregister(struct page_reporting_dev_info *prdev)
{
    ...
    if (prdev == rcu_dereference_protected(pr_dev_info, lockdep_is_held(&page_reporting_mutex)))
    {
