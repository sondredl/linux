                             ...
                             unsigned long total_size)
{
    ...
    if ((type & MAP_FIXED_NOREPLACE) && PTR_ERR((void *)map_addr) == -EEXIST)
                                ...
                                struct arch_elf_state *arch)
{
    ...
    if (note.nhdr.n_type != NT_GNU_PROPERTY_TYPE_0 || note.nhdr.n_namesz != NOTE_NAME_SZ || strncmp(note.data + sizeof(note.nhdr), GNU_PROPERTY_TYPE_0_NAME, n - sizeof(note.nhdr)))
        return -ENOEXEC;
