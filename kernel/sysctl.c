                                        ...
                                        int write, void *data)
{
    ...
    if (write)
    {
        if ((param->min && *param->min > tmp) || (param->max && *param->max < tmp))
            return -EINVAL;
        WRITE_ONCE(*valp, tmp);
    }
...
static struct ctl_table kern_table[] = {
    ...
    #if (defined(CONFIG_X86_32) || defined(CONFIG_PARISC)) && defined(CONFIG_DEBUG_STACKOVERFLOW)
    {
...
static struct ctl_table vm_table[] = {
    ...
    #endif
    #if (defined(CONFIG_X86_32) && !defined(CONFIG_UML)) || (defined(CONFIG_SUPERH) && defined(CONFIG_VSYSCALL))
    {
