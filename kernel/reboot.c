...
{
    if (platform_power_off_handler && platform_power_off_handler->cb_data == power_off)
    {
...
{
    return !atomic_notifier_call_chain_is_empty(&power_off_handler_list) || pm_power_off;
}
